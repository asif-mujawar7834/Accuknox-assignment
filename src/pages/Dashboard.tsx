      ...
      <div className="p-4 md:p-10 text-black mt-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div
            ...
            } w-max top-[155px] rounded-md p-3 backdrop-blur-md md:top-auto md:p-0 right-4 z-10 md:z-auto bg-gray-300/30 flex flex-col md:bg-transparent md:relative md:flex-row items-center gap-4 text-gray-500`}
          >
